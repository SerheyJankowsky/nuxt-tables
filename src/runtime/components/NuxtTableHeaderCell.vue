...
<template>
  <th
    ...
    :class="[
      ...
      props.isDragOver && !props.isDragSource
        ? props.classNames.headerCellDragOver
        : '',
    ]"
    :draggable="props.isDndEnabled"
    @dragstart="
      props.isDndEnabled ? emit('dragStart', props.column.key) : undefined
    "
    @dragover.prevent="
      props.isDndEnabled ? emit('dragOver', props.column.key) : undefined
    "
    @dragenter.prevent="
      props.isDndEnabled ? emit('dragOver', props.column.key) : undefined
    "
    @dragleave="
      props.isDndEnabled ? emit('dragLeave', props.column.key) : undefined
    "
